...
//    val serializedBlock = doTestSerialize[TestBlock](block, rounds)
...
//  }
//
//  def doTestSerialize[T <: RLPSerializable](toSerialize: T, rounds: Int): Array[Byte] = {
//    (1 until rounds).foreach(_ => { toSerialize.toRLP })
//    toSerialize.toRLP
//  }
//
//  def doTestDeserialize[T](serialized: Array[Byte], f: Array[Byte] => T, rounds: Int): T = {
//    (1 until rounds).foreach(_ => { f(serialized) })
//    f(serialized)
//  }
//
